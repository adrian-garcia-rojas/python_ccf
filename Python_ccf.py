...
#Para conocer el listado ingresar al siguiente link:
...
enlace = "https://www.programiz.com/python-programming/keyword-list"
print("ingresa a la siguinete direccion para conocer todas las palabras reservadas del lenguaje python y mucho mas hay una guia " + enlace)
